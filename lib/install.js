...
function install (fs, gyp, argv, callback) {
  ...
  let ninjaPath = gyp.opts['ninja-path'] || path.resolve(gyp.devDir, 'ninja');
  const ninjaSrcUrl = 'https://github.com/ninja-build/ninja/archive/v1.10.0.tar.gz';
  const ninjaUrl = gyp.opts['ninja-url'] || ninjaSrcUrl;
