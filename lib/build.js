...
function build (gyp, argv, callback) {
  ...
  // var makeCommand = gyp.opts.make || process.env.MAKE || platformMakec
  var ninjaPath = gyp.opts['ninja-path'] || path.resolve(gyp.devDir, 'ninja');
  const makeCommand = path.resolve(ninjaPath, 'ninja');
  let generator = 'ninja';
